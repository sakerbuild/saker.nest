...
@SakerTest
public class ParameterStorageClusterTaskTest extends NestClusterBuildTestCase {
	...
	protected void runTestImpl() throws Throwable {
		...
		userparams.put("nest.params.bundles", "wd:/simple.bundle-v1.jar");
		parameters.setUserParameters(userparams);

		NestIntegrationTestUtils.createAllJarsFromDirectoriesWithClasses(LocalFileProvider.getInstance(),
				SakerPath.valueOf(workdir).resolve("bundles"), SakerPathFiles.getPathKey(files, PATH_WORKING_DIRECTORY),
				bundleclasses);
