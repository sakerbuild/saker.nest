...
@SakerTest
public class ExternalDependencyEntrySerializationTaskTest extends CollectingMetricEnvironmentTestCase {
	//just a random uuid
	private static final String PROPERTY_NAME = "5c9dd65a-4079-4daf-a354-a2690c9295fb";
	...
	private ExternalArchiveResolvingNestMetric nm = new ExternalArchiveResolvingNestMetric();
	{
		try {
			...
			entries.put(SakerPath.valueOf("lib/lib.jar"),
